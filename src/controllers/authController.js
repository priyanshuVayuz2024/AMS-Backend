...
const sendErrorResponse = ({ res, statusCode = 500, message = "Something went wrong" }) => {
...
export const login = async (req, res) => {
    try {
        ...
        if (!user) {
            ...
            // Update syncedAt and optional info
        ...
        return sendErrorResponse({ res, statusCode: 500, message: "Login failed" });
    }
};
